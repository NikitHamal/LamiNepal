...
/// Contains the number of days in each month for Nepali years
/// This data is essential for accurate BS to AD conversion
///
...
class NepaliDatesData {
  ...
  static const int maxYear = 2090;

  /// Month days for each year
  /// Key: Year (BS), Value: List of 12 integers representing days in each month
  static const Map<int, List<int>> monthDays = {
